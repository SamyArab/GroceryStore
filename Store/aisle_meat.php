...
<?php if(isset($_SESSION['email'])){ ?>
    ...
    <main>
        ...
        <h2 class="item--title">MEAT PRODUCTS</h2>
        <section class="item--list">

            <a href="/Store/meat_products/ground_beef.php" style="text-decoration: inherit; color: inherit;">
                <div class="items">
                    <img src="/Images/meat/ground_beef.png" alt="Ground Beef">
                    <div class="item--info">
            ...
            <a href="/Store/meat_products/halal_beef.php" style="text-decoration: inherit; color: inherit;">
                <div class="items">
                    <img src="/Images/meat/halal_beef.png" alt="Halal Beef">
                    <div class="item--info">
                        <div class="item--labels">
                            <h3>Halal Beef</h3>
            ...
            <a href="/Store/meat_products/whole_chicken.php" style="text-decoration: inherit; color: inherit;">
                <div class="items">
                    <img src="/Images/meat/whole_chicken.png" alt="Whole Chicken">
                    <div class="item--info">
                        <div class="item--labels">
                            <h3>Whole Chicken</h3>
