...
if(isset($_POST["addToCart"])){
    if(isset($_SESSION["email"])){
          ...
          array_push($array, ($product . " /Images/f&v/broccoli.png"));
          $_SESSION["shoppingCart"] = json_encode($array, 0, 512);
          
        }else{
          $x = (int)(substr($array[$counter], stripos($array[$counter],":", 0)+1, stripos($array[$counter], "/Images/f&v/broccoli.png", 0)));
          ...
          $array[$counter] = $product . $data . " /Images/f&v/broccoli.png";
          $_SESSION["shoppingCart"] = json_encode($array, 0, 512);
...
<body onload="getSavedVal('Broccoli', 1.99)">
    <header class="header">
...
<?php if(isset($_SESSION['email'])){ ?>
    ...
    <main>
        ...
        <div class="item--container">
            ...
            <div class="info">
                ...
                <div class="quantity--controls">
                    <button class="quantity--sign minus" onclick="buttonHandling(this, 'Broccoli', 1.99)"><img src="/Images/minus.png" alt="minus sign"></button>
                    <input type="number" name="quantity" min="1" value="1" onchange="buttonHandling(this, 'Broccoli', 1.99)">
                    <button class="quantity--sign plus" onclick="buttonHandling(this, 'Broccoli', 1.99)"><img src="/Images/plus.png" alt="plus sign"></button>
                </div>
                <button class="add--cart" name = "addToCart" onclick = "submitHandling('Broccoli')">ADD TO CART</button>
                </form>
        ...
        <p class="description"> <span>DESCRIPTION</span> <br> Broccoli has a boldly unique flavor 
            making it perfect to serve as a standalone dish or as part of a recipe. In addition to its unique flavor, 
            this veggie contains a powerful nutritious mix of vitamins and minerals including high levels of vitamins A, C and K.
        </p>
