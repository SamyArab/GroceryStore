...
if(isset($_POST["addToCart"])){
    if(isset($_SESSION["email"])){
          ...
          array_push($array, ($product . " /Images/f&v/onions.png"));
          $_SESSION["shoppingCart"] = json_encode($array, 0, 512);
          
        }else{
          $x = (int)(substr($array[$counter], stripos($array[$counter],":", 0)+1, stripos($array[$counter], "/Images/f&v/onions.png", 0)));
          ...
          $array[$counter] = $product . $data . " /Images/f&v/onions.png";
          $_SESSION["shoppingCart"] = json_encode($array, 0, 512);
    ...
    <main>
        ...
        <div class="item--container">
            ...
            <div class="info">
                ...
                <button class="add--cart" name = "addToCart" onclick = "submitHandling('Onions')">ADD TO CART</button>
                </form>
