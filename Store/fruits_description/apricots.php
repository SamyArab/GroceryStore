...
if(isset($_POST["addToCart"])){
    if(isset($_SESSION["email"])){
          ...
          array_push($array, ($product . " /Images/f&v/apricots.png"));
          $_SESSION["shoppingCart"] = json_encode($array, 0, 512);
          
        }else{
          $x = (int)(substr($array[$counter], stripos($array[$counter],":", 0)+1, stripos($array[$counter], "/Images/f&v/apricots.png", 0)));
          ...
          $array[$counter] = $product . $data . " /Images/f&v/apricots.png";
          $_SESSION["shoppingCart"] = json_encode($array, 0, 512);
...
<body onload="getSavedVal('Apricots', 1.19)">
    <header class="header">
...
<?php if(isset($_SESSION['email'])){ ?>
    ...
    <main>
        ...
        <div class="item--container">
            ...
            <div class="info">
                <h3 class="name">Sweet Apricots</h3>
                <span class="price">$1.19/each</span>
                <span class="price" id="price">Total: $1.19</span>
                <form method = "POST">
                <div class="quantity--controls">
                    <button class="quantity--sign minus" onclick="buttonHandling(this, 'Apricots', 1.19)"><img src="/Images/minus.png" alt="minus sign"></button>
                    <input type="number" name="quantity" min="1" value="1" onchange="buttonHandling(this, 'Apricots', 1.19)">
                    <button class="quantity--sign plus" onclick="buttonHandling(this, 'Apricots', 1.19)"><img src="/Images/plus.png" alt="plus sign"></button>
                </div>
                <button class="add--cart" name = "addToCart" onclick = "submitHandling('Apricots')">ADD TO CART</button>
                </form>
        ...
        <p class="description"> <span>DESCRIPTION</span> <br> Apricots are a good source of vitamin A and 
            are high in natural sugar. Dried apricots are an excellent source of iron. 
        </p>
