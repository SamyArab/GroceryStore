...
if(isset($_POST["addToCart"])){
    if(isset($_SESSION["email"])){
          ...
          array_push($array, ($product . " /Images/f&v/cauliflower.png"));
          $_SESSION["shoppingCart"] = json_encode($array, 0, 512);
          
        }else{
          $x = (int)(substr($array[$counter], stripos($array[$counter],":", 0)+1, stripos($array[$counter], "/Images/f&v/cauliflower.png", 0)));
          ...
          $array[$counter] = $product . $data . " /Images/f&v/cauliflower.png";
          $_SESSION["shoppingCart"] = json_encode($array, 0, 512);
    ...
    <main>
        ...
        <div class="item--container">
            ...
            <div class="info">
                ...
                <button class="add--cart" name = "addToCart" onclick = "submitHandling('Cauliflower')">ADD TO CART</button>
                </form>
