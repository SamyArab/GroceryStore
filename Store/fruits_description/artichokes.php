...
if(isset($_POST["addToCart"])){
    if(isset($_SESSION["email"])){
          ...
          array_push($array, ($product . " /Images/f&v/artichokes.png"));
          $_SESSION["shoppingCart"] = json_encode($array, 0, 512);
          
        }else{
          $x = (int)(substr($array[$counter], stripos($array[$counter],":", 0)+1, stripos($array[$counter], "/Images/f&v/artichokes.png", 0)));
          ...
          $array[$counter] = $product . $data . " /Images/f&v/artichokes.png";
          $_SESSION["shoppingCart"] = json_encode($array, 0, 512);
...
<body onload="getSavedVal('Artichokes', 1.99)">
    <header class="header">
...
<?php if(isset($_SESSION['email'])){ ?>
    ...
    <main>
        ...
        <div class="item--container">
            ...
            <div class="info">
                <h3 class="name">Fresh Artichokes</h3>
                <span class="price">$1.99/each</span>
                <span class="price" id="price">Total: $1.99</span>
                <form method = "POST">
                <div class="quantity--controls">
                    <button class="quantity--sign minus" onclick="buttonHandling(this, 'Artichokes', 1.99)"><img src="/Images/minus.png" alt="minus sign"></button>
                    <input type="number" name="quantity" min="1" value="1" onchange="buttonHandling(this, 'Artichokes', 1.99)">
                    <button class="quantity--sign plus" onclick="buttonHandling(this, 'Artichokes', 1.99)"><img src="/Images/plus.png" alt="plus sign"></button>
                </div>
                <button class="add--cart" name = "addToCart" onclick = "submitHandling('Artichokes')">ADD TO CART</button>
                </form>
        ...
        <p class="description"> <span>DESCRIPTION</span> <br> The artichoke is an immature bud, 
            if left to grown becomes a bright-purple thistle-like flower often seen at the farmer's market in bouquets. 
            The center of the artichoke, the "choke", is inedible with the most desired portion being the "heart."
        </p>
