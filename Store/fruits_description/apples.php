...
if(isset($_POST["addToCart"])){
    if(isset($_SESSION["email"])){
          ...
          array_push($array, ($product . " /Images/f&v/apples.png"));
          $_SESSION["shoppingCart"] = json_encode($array, 0, 512);
          
        }else{
          $x = (int)(substr($array[$counter], stripos($array[$counter],":", 0)+1, stripos($array[$counter], "/Images/f&v/apples.png", 0)));
          ...
          $array[$counter] = $product . $data . " /Images/f&v/apples.png";
          $_SESSION["shoppingCart"] = json_encode($array, 0, 512);
...
<body onload="getSavedVal('Apples', 0.99)">
    <header class="header">
...
<?php if(isset($_SESSION['email'])){ ?>
    ...
    <main>
        ...
        <div class="item--container">
            ...
            <div class="info">
                <h3 class="name">Fresh Macintosh Apples</h3>
                <span class="price">$.99/each</span>
                <span class="price" id="price">Total: $0.99</span>
                <form method = "POST">
                <div class="quantity--controls">
                    <button class="quantity--sign minus" onclick="buttonHandling(this, 'Apples', 0.99)"><img src="/Images/minus.png" alt="minus sign"></button>
                    <input type="number" name="quantity" min="1" value="1" onchange="buttonHandling(this, 'Apples', 0.99)">
                    <button class="quantity--sign plus" onclick="buttonHandling(this, 'Apples', 0.99)"><img src="/Images/plus.png" alt="plus sign"></button>
                </div>
                <button class="add--cart" name = "addToCart" onclick = "submitHandling('Apples')">ADD TO CART</button>
                </form>
        ...
        <p class="description"> <span>DESCRIPTION</span> <br> Apples with their skin are a top source of dietary fiber,
            vitamin C and are the second most popular fruit after bananas. Apple skin also contains many phytochemicals,
            such as quercetin, under research for potential health effects.
        </p>
