...
if(isset($_POST["addToCart"])){
    if(isset($_SESSION["email"])){
          ...
          array_push($array, ($product . " /Images/snacks/AppleJuice.png"));
          $_SESSION["shoppingCart"] = json_encode($array, 0, 512);
          
        }else{
          $x = (int)(substr($array[$counter], stripos($array[$counter],":", 0)+1, stripos($array[$counter], "/Images/snacks/AppleJuice.png", 0)));
          ...
          $array[$counter] = $product . $data . " /Images/snacks/AppleJuice.png";
          $_SESSION["shoppingCart"] = json_encode($array, 0, 512);
...
<body onload="getSavedVal('Apple Juice', 7.99)">
    <header class="header">
...
<?php if(isset($_SESSION['email'])){ ?>
    ...
    <main>
        ...
        <div class="item--container">
            <img src="/Images/snacks/AppleJuice.png" alt="AppleJuice">

            <div class="info">
                <h3 class="name">Apple Juice</h3>
                <span class="price">$7.99/bottle</span>
                <span class="price" id="price">Total: $7.99</span>
                <form method = "POST">
                <div class="quantity--controls">
                    <button class="quantity--sign minus" onclick="buttonHandling(this, 'AppleJuice', 7.99)"><img src="/Images/minus.png" alt="minus sign"></button>
                    <input type="number" name="quantity" min="1" value="1" onchange="buttonHandling(this, 'AppleJuice', 7.99)">
                    <button class="quantity--sign plus" onclick="buttonHandling(this, 'AppleJuice', 7.99)"><img src="/Images/plus.png" alt="plus sign"></button>
                </div>
                <button class="add--cart" name = "addToCart" onclick = "submitHandling('AppleJuice')"> ADD TO CART </button>
                </form>
        ...
        <p class="description dropdown-content"> <span>Description</span>
            <br>A 1L bottle of apple juice from concentrate with added Vitamin C! A sweet beverage, with no added sugar,
            to go along with most meals!
        </p>
