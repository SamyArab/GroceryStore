...
if(isset($_POST["addToCart"])){
    if(isset($_SESSION["email"])){
          ...
          array_push($array, ($product . " /Images/snacks/OrangeJuice.png"));
          $_SESSION["shoppingCart"] = json_encode($array, 0, 512);
          
        }else{
          $x = (int)(substr($array[$counter], stripos($array[$counter],":", 0)+1, stripos($array[$counter], "/Images/snacks/OrangeJuice.png", 0)));
          ...
          $array[$counter] = $product . $data . " /Images/snacks/OrangeJuice.png";
          $_SESSION["shoppingCart"] = json_encode($array, 0, 512);
...
<body onload="getSavedVal('OrangeJuice', 6.99)">
    <header class="header">
...
<?php if(isset($_SESSION['email'])){ ?>
    ...
    <main>
        ...
        <div class="item--container">
            <img src="/Images/snacks/OrangeJuice.png" alt="OrangeJuice">

            <div class="info">
                <h3 class="name">Orange Juice</h3>
                <span class="price">$6.99/bottle</span>
                <span class="price" id="price">Total: $6.99</span>
                <form method = "POST">
                <div class="quantity--controls">
                    <button class="quantity--sign minus" onclick="buttonHandling(this, 'OrangeJuice', 6.99)"><img src="/Images/minus.png" alt="minus sign"></button>
                    <input type="number" name="quantity" min="1" value="1" onchange="buttonHandling(this, 'OrangeJuice', 6.99)">
                    <button class="quantity--sign plus" onclick="buttonHandling(this, 'OrangeJuice', 6.99)"><img src="/Images/plus.png" alt="plus sign"></button>
                </div>
                <button class="add--cart" name = "addToCart" onclick = "submitHandling('OrangeJuice')"> ADD TO CART </button>
                </form>
        ...
        <p class="description dropdown-content"> <span>Description</span>
            <br>A 1.54L bottle of delicious Orange Juice not from concentrate. Enjoy the next best thing to
            freshly-squeezed orange juice! Great source for Vitamin C as well!
        </p>
