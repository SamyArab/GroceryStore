...
if(isset($_POST["addToCart"])){
    if(isset($_SESSION["email"])){
          ...
          $product = "Chardonnay_Wine 9.99 Qty:";
          $alreadyExists = false;
          ...
          array_push($array, ($product . " /Images/snacks/BogleChardonnay.png"));
          $_SESSION["shoppingCart"] = json_encode($array, 0, 512);
          
        }else{
          $x = (int)(substr($array[$counter], stripos($array[$counter],":", 0)+1, stripos($array[$counter], "/Images/snacks/BogleChardonnay.png", 0)));
          ...
          $array[$counter] = $product . $data . " /Images/snacks/BogleChardonnay.png";
          $_SESSION["shoppingCart"] = json_encode($array, 0, 512);
...
<html>
    ...
    <head>
        ...
        <title>Chardonnay Wine</title>
    </head>
    
    <body onload="getSavedVal('Chardonnay', .99)">
        <header class="header">
...
<?php if(isset($_SESSION['email'])){ ?>
    ...
    <main>
        ...
        <div class="item--container">
            <img src="/Images/snacks/BogleChardonnay.png" alt="BogleChardonnay">
    
            <div class="info">
                <h3 class="name">Chardonnay White Wine</h3>
                <span class="price">$9.99/bottle</span>
                <span class="price" id="price">Total: $9.99</span>
                <form method = "POST">
                <div class="quantity--controls">
                    <button class="quantity--sign minus" onclick="buttonHandling(this, 'Chardonnay', 9.99)"><img src="/Images/minus.png" alt="minus sign"></button>
        ...
        <p class="description dropdown-content"> <span>Description</span>
            <br>A 750mL bottle of hand-crafted wine. With careful fermentation processes, an elegant wine was produced that can be a favourite to many with it's Vanilla, Nutmeg, and Guava taste.
        </p>
