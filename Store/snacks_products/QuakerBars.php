...
if(isset($_POST["addToCart"])){
    if(isset($_SESSION["email"])){
          ...
          array_push($array, ($product . " /Images/snacks/QuakerBars.png"));
          $_SESSION["shoppingCart"] = json_encode($array, 0, 512);
          
        }else{
          $x = (int)(substr($array[$counter], stripos($array[$counter],":", 0)+1, stripos($array[$counter], "/Images/snacks/QuakerBars.png", 0)));
          ...
          $array[$counter] = $product . $data . " /Images/snacks/QuakerBars.png";
          $_SESSION["shoppingCart"] = json_encode($array, 0, 512);
...
<head>
    ...
    <title>Quaker Bars</title>
</head>

<body onload="getSavedVal('Granola Bars', 4.99)">
    <header class="header">
...
<?php if(isset($_SESSION['email'])){ ?>
    ...
    <main>
        <a href="/Store/aisle_snacks.php" class="back"> BACK </a>



        <div class="item--container">
            <img src="/Images/snacks/QuakerBars.png" alt="QuakerBars">

            <div class="info">
                <h3 class="name">Chocolate Chip Granola Bars</h3>
                <span class="price">$4.99/box</span>
                <span class="price" id="price">Total: $4.99</span>
                <form method = "POST">
                <div class="quantity--controls">
                    <button class="quantity--sign minus" onclick="buttonHandling(this, 'Granola Bars', 4.99)"><img src="/Images/minus.png" alt="minus sign"></button>
                    <input type="number" name="quantity" min="1" value="1" onchange="buttonHandling(this, 'Granola Bars', 4.99)">
                    <button class="quantity--sign plus" onclick="buttonHandling(this, 'Granola Bars', 4.99)"><img src="/Images/plus.png" alt="plus sign"></button>
                </div>
                <button class="add--cart" name = "addToCart" onclick = "submitHandling('Granola Bars')"> ADD TO CART </button>
                </form>
        ...
        <p class="description dropdown-content"> <span>Description</span>
            <br>A box of 8 chocolate chip granola bars, containing real chocolate chips whilst excluding artificial
            preservatives, flavours, and colors, this is the perfect snack at only 100 calories per bar.
        </p>
