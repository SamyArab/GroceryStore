...
if(isset($_POST["addToCart"])){
    if(isset($_SESSION["email"])){
          ...
          $product = "Ritz_Crackers 3.99 Qty:";
          $alreadyExists = false;
          ...
          array_push($array, ($product . " /Images/snacks/RitzCrackers.png"));
          $_SESSION["shoppingCart"] = json_encode($array, 0, 512);
          
        }else{
          $x = (int)(substr($array[$counter], stripos($array[$counter],":", 0)+1, stripos($array[$counter], "/Images/snacks/RitzCrackers.png", 0)));
          ...
          $array[$counter] = $product . $data . " /Images/snacks/RitzCrackers.png";
          $_SESSION["shoppingCart"] = json_encode($array, 0, 512);
...
<head>
    ...
    <title>Ritz Crackers</title>
</head>

<body onload="getSavedVal('Crackers', 3.99)">
    <header class="header">
...
<?php if(isset($_SESSION['email'])){ ?>
    ...
    <main>
        ...
        <div class="item--container">
            <img src="/Images/snacks/RitzCrackers.png" alt="RitzCrackers">

            <div class="info">
                <h3 class="name">Ritz Original Crackers</h3>
                <span class="price">$3.99/box</span>
                <span class="price" id="price">Total: $3.99</span>
                <form method = "POST">
                <div class="quantity--controls">
                    <button class="quantity--sign minus" onclick="buttonHandling(this, 'Crackers', 3.99)"><img src="/Images/minus.png" alt="minus sign"></button>
                    <input type="number" name="quantity" min="1" value="1" onchange="buttonHandling(this, 'Crackers', 3.99)">
                    <button class="quantity--sign plus" onclick="buttonHandling(this, 'Crackers', 3.99)"><img src="/Images/plus.png" alt="plus sign"></button>
                </div>
                <button class="add--cart" name = "addToCart" onclick = "submitHandling('Crackers')"> ADD TO CART </button>
                </form>
        ...
        <p class="description dropdown-content"> <span>Description</span>
            <br>A 350 g box of classic saltine Ritz crackers. A classic snack for any occasion that can be enjoyedon its
            own or with a variety of toppings!
        </p>
