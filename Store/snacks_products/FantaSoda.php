...
if(isset($_POST["addToCart"])){
    if(isset($_SESSION["email"])){
          ...
          $x = (int)(substr($array[$counter], stripos($array[$counter],":", 0)+1, stripos($array[$counter], "/Images/snacks/Fanta.png", 0)));
          ...
          $array[$counter] = $product . $data . " /Images/snacks/Fanta.png";
          $_SESSION["shoppingCart"] = json_encode($array, 0, 512);
...
<html>
    ...
    <head>
        ...
        <title>Fanta Soda</title>
    </head>
    
    <body onload="getSavedVal('Fanta', 5.99)">
        <header class="header">
...
<?php if(isset($_SESSION['email'])){ ?>
    ...
    <main>
        ...
        <div class="item--container">
            <img src="/Images/snacks/Fanta.png" alt="Fanta">
    
            <div class="info">
                <h3 class="name">Fanta Orange Soda</h3>
                <span class="price">$5.99/bottle</span>
                <span class="price" id="price">Total: $5.99</span>
                <form method = "POST">
                <div class="quantity--controls">
                    <button class="quantity--sign minus" onclick="buttonHandling(this, 'Fanta', 5.99)"><img src="/Images/minus.png" alt="minus sign"></button>
        ...
        <p class="description dropdown-content"> <span>Description</span>
            <br>A 2L bottle of bubbly, Naturally flavoured Soda beverage! Caffeine and GMO free, this bright and refreshing soda will instantly quench your thirst!
        </p>
