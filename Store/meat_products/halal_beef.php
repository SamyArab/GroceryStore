...
if(isset($_POST["addToCart"])){
    if(isset($_SESSION["email"])){
          ...
          array_push($array, ($product . " /Images/meat/halal_beef.png"));
          $_SESSION["shoppingCart"] = json_encode($array, 0, 512);
          
        }else{
          $x = (int)(substr($array[$counter], stripos($array[$counter],":", 0)+1, stripos($array[$counter], "/Images/meat/halal_beef.png", 0)));
          ...
          $array[$counter] = $product . $data . " /Images/meat/halal_beef.png";
          $_SESSION["shoppingCart"] = json_encode($array, 0, 512);
...
<head>
    ...
    <title>Halal Beef</title>
</head>

<body onload="getSavedVal('Halal Beef', 7.39)">
    <header class="header">
...
<?php if(isset($_SESSION['email'])){ ?>
    ...
    <main>
        ...
        <div class="item--container">
            ...
            <div class="info">
                <h3 class="name">Halal Beef</h3>
                <span class="price">$7.39/lb</span>
                <span class="price" id="price">Total: 7.39</span>
                <form method = "POST">
                <div class="quantity--controls">
                    <button class="quantity--sign minus" onclick="buttonHandling(this, 'Halal Beef', 7.39)"><img src="/Images/minus.png" alt="minus sign"></button>
                    <input type="number" name="quantity" min="1" value="1" onchange="buttonHandling(this, 'Halal Beef', 7.39)">
                    <button class="quantity--sign plus" onclick="buttonHandling(this, 'Halal Beef', 7.39)"><img src="/Images/plus.png" alt="plus sign"></button>

                </div>
                <button class="add--cart" name = "addToCart" onclick = "submitHandling('Halal Beef')">ADD TO CART</button>
                </form>
        ...
        <p class="description dropdown-content">
            ...
            119.3g of protein/lb, 53.9g of fat/lb, Halal Beef. Good for protein, iron, and vitamin B12. Beef that is
            perfect for all of your recipes!
        </p>
