...
if(isset($_POST["addToCart"])){
    if(isset($_SESSION["email"])){
          ...
          array_push($array, ($product . " /Images/dairy/milk.png"));
          $_SESSION["shoppingCart"] = json_encode($array, 0, 512);
          
        }else{
          $x = (int)(substr($array[$counter], stripos($array[$counter],":", 0)+1, stripos($array[$counter], "/Images/dairy/milk.png", 0)));
          ...
          $array[$counter] = $product . $data . " /Images/dairy/milk.png";
          $_SESSION["shoppingCart"] = json_encode($array, 0, 512);
...
<body onload="getSavedVal('Milk', 2.19)">
    <header class="header">
...
<?php if(isset($_SESSION['email'])){ ?>
    ...
    <main>
        ...
        <div class="item--container">
            <img src="/Images/dairy/milk.png" alt="cheese">
    
            <div class="info">
                <h3 class="name">1 Percent Milk</h3>
                <span class="price">$2.19/each</span>
                <span class="price" id="price">Total: $2.19</span>
                <form method = "POST">
                <div class="quantity--controls">
                    <button class="quantity--sign minus" onclick="buttonHandling(this, 'Milk', 2.19)"><img src="/Images/minus.png" alt="minus sign"></button>
                    <input type="number" name="quantity" min="1" value="1" onchange="buttonHandling(this, 'Milk', 2.19)">
                    <button class="quantity--sign plus" onclick="buttonHandling(this, 'Milk', 2.19)"><img src="/Images/plus.png" alt="plus sign"></button>
                </div>
                <button class="add--cart" name = "addToCart" onclick = "submitHandling('Milk')">ADD TO CART</button>
                </form>
        ...
        <p class="description"> <span>DESCRIPTION</span> <br>A 2 litre container of 1 percent milk. 1 percent milk is low in fat and a high in calcium. Milk is also a source of protein and potassium.
        </p>
    </main>
</body>
</html>
