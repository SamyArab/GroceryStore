...
if(isset($_POST["addToCart"])){
    if(isset($_SESSION["email"])){
          ...
          array_push($array, ($product . " /Images/dairy/cheese.png"));
          $_SESSION["shoppingCart"] = json_encode($array, 0, 512);
          
        }else{
          $x = (int)(substr($array[$counter], stripos($array[$counter],":", 0)+1, stripos($array[$counter], "/Images/dairy/cheese.png", 0)));
          ...
          $array[$counter] = $product . $data . " /Images/dairy/cheese.png";
          $_SESSION["shoppingCart"] = json_encode($array, 0, 512);
...
<body onload="getSavedVal('Cheese', 5.79)">
    <header class="header">
...
<?php if(isset($_SESSION['email'])){ ?>
    ...
    <main>
        ...
        <div class="item--container">
            ...
            <div class="info">
                <h3 class="name">Swiss Cheese</h3>
                <span class="price">$5.79/each</span>
                <span class="price" id="price">Total: $5.79</span>
                <form method = "POST">
                <div class="quantity--controls">
                    <button class="quantity--sign minus" onclick="buttonHandling(this, 'Cheese', 5.79)"><img src="/Images/minus.png" alt="minus sign"></button>
                    <input type="number" name="quantity" min="1" value="1" onchange="buttonHandling(this, 'Cheese', 5.79)">
                    <button class="quantity--sign plus" onclick="buttonHandling(this, 'Cheese', 5.79)"><img src="/Images/plus.png" alt="plus sign"></button>
                </div>
                <button class="add--cart" name = "addToCart" onclick = "submitHandling('Cheese')">ADD TO CART</button>
                </form>
        ...
        <p class="description"> <span>DESCRIPTION</span> <br> 400 grams of swiss cheese. Cheese is a source of calcium and
            protein. Cheese is also high in sodium and fat.
        </p>
    </main>
</body>
