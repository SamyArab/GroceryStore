...
if(isset($_POST["addToCart"])){
    if(isset($_SESSION["email"])){
          ...
          array_push($array, ($product . " /Images/dairy/ice_cream.png"));
          $_SESSION["shoppingCart"] = json_encode($array, 0, 512);
          
        }else{
          $x = (int)(substr($array[$counter], stripos($array[$counter],":", 0)+1, stripos($array[$counter], "/Images/dairy/ice_cream.png", 0)));
          ...
          $array[$counter] = $product . $data . " /Images/dairy/ice_cream.png";
          $_SESSION["shoppingCart"] = json_encode($array, 0, 512);
...
<body onload="getSavedVal('Ice Cream', 6.59)">
    <header class="header">
...
<?php if(isset($_SESSION['email'])){ ?>
    ...
    <main>
        ...
        <div class="item--container">
            ...
            <div class="info">
                <h3 class="name">Ice Cream</h3>
                <span class="price">$6.59/each</span>
                <span class="price" id="price">Total: $6.59</span>
                <form method = "POST">
                <div class="quantity--controls">
                    <button class="quantity--sign minus" onclick="buttonHandling(this, 'Ice Cream', 6.59)"><img src="/Images/minus.png" alt="minus sign"></button>
                    <input type="number" name="quantity" min="1" value="1" onchange="buttonHandling(this, 'Ice Cream', 6.59)">
                    <button class="quantity--sign plus" onclick="buttonHandling(this, 'Ice Cream', 6.59)"><img src="/Images/plus.png" alt="plus sign"></button>
                </div>
                <button class="add--cart" name = "addToCart" onclick = "submitHandling('Ice Cream')">ADD TO CART</button>
                </form>
        ...
        <p class="description"> <span>DESCRIPTION</span> <br>A 2 litre container of ice cream containing 5 flavours. Flavours include vanilla, mint, blue moon, chocolate, and strawberry. Ice cream is high in sugar and contains artificial ingredients.
        </p>
    </main>
</body>
</html>
