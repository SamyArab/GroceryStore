...
<body onload="getSavedVal('Croissant', 1.99)">
    <header class="header">
    ...
    <main>
        ...
        <div class="item--container">
            ...
            <div class="info">
                ...
                <button class="add--cart" name = "addToCart" onclick = "submitHandling('Croissant')"> ADD TO CART </button>
                </form>
        ...
        <p class="description"> <span>Description</span>
            <br>Bite into the perfectly buttery and delightfully flaky Your Fresh Market™ All Butter Croissants. You'll
            find delicate layers of temptingly tender pastry wrapped in a lightly crisp, golden crust, all free from
            artificial flavours and colours. Savoured at breakfast, sliced for sandwiches, or paired with soup-enjoy
            these crescent-shaped rolls of pastry heaven however and whenever you please!
        </p>
