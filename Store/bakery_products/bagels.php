...
if(isset($_POST["addToCart"])){
    if(isset($_SESSION["email"])){
          ...
          if($alreadyExists == false){
            ...
            array_push($array, ($product . " /Images/bakery/bagels.jpg"));
            $_SESSION["shoppingCart"] = json_encode($array, 0, 512);
            
          }else{
            $x = (int)(substr($array[$counter], stripos($array[$counter],":", 0)+1, stripos($array[$counter], "/Images/bakery/bagels.jpg", 0)));
            ...
            $array[$counter] = $product . $data . " /Images/bakery/bagels.jpg";
            $_SESSION["shoppingCart"] = json_encode($array, 0, 512);
...
<body onload="getSavedVal('Bagels', 2.97)">
    <header class="header">
...
<?php if(isset($_SESSION['email'])){ ?>
    ...
    <main>
        <a href="/Store/aisle_bakery.php" class="back"> BACK </a>



        <div class="item--container">
            <img src="/Images/bakery/bagels.jpg" alt="Bagels">

            <div class="info">
                <h3 class="name">Bagels</h3>
                <span class="price">$2.97/ea</span>
                <span class="price" id="price">Total: $2.97</span>
                <form method = "POST">
                <div class="quantity--controls">
                    <button class="quantity--sign minus" onclick="buttonHandling(this, 'Bagels', 2.97)"><img src="/Images/minus.png" alt="minus sign"></button>
                    <input type="number" name="quantity" min="1" value="1" onchange="buttonHandling(this, 'Bagels', 2.97)">
                    <button class="quantity--sign plus" onclick="buttonHandling(this, 'Bagels', 2.97)"><img src="/Images/plus.png" alt="plus sign"></button>
                </div>
                <button class="add--cart" name = "addToCart" onclick = "submitHandling('Bagels')"> ADD TO CART </button>
                </form>
        ...
        <p class="description"> <span>Description</span>
            <br> We bake fresh daily from coast to coast the Canadian way, with dedicated bakers choosing Canadian wheat
            flour and quality ingredients. Our bagels are perfect for toasting; with a crispy outside they stay soft and
