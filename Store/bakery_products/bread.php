...
<body onload="getSavedVal('Bread', 3.49)">
    <header class="header">
...
<?php if(isset($_SESSION['email'])){ ?>
    ...
    <main>
        ...
        <img src="/Images/bakery/bread.png" alt="Bread">

        <div class="info">
            <h3 class="name">Bread</h3>
            <span class="price">$3.49/ea</span>
            <span class="price" id="price">Total: $3.49</span>
            <form method = "POST">
            <div class="quantity--controls">
                <button class="quantity--sign minus" onclick="buttonHandling(this, 'Bread', 3.49)"><img src="/Images/minus.png" alt="minus sign"></button>
            ...
            <button class="add--cart" name = "addToCart" onclick = "submitHandling('Bread')"> ADD TO CART </button>
            </form> 
    ...
    <p class="description"> <span>Description</span>
        <br>A classic choice, White Bread is delicious any time of the day. It’s made with our simplest ingredients and no artificial flavours or colours for great taste the whole family will love.
    </p>
