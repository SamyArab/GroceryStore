...
if(isset($_POST["addToCart"])){
    if(isset($_SESSION["email"])){
          ...
          array_push($array, ($product . " /Images/bakery/pie.jpg"));
          $_SESSION["shoppingCart"] = json_encode($array, 0, 512);
          
        }else{
          $x = (int)(substr($array[$counter], stripos($array[$counter],":", 0)+1, stripos($array[$counter], "/Images/bakery/pie.jpg", 0)));
          ...
          $array[$counter] = $product . $data . " /Images/bakery/pie.jpg";
          $_SESSION["shoppingCart"] = json_encode($array, 0, 512);
...
<?php if(isset($_SESSION['email'])){ ?>
    ...
    <main>
        ...
        <div class="info">
            ...
            <button class="add--cart" name = "addToCart" onclick = "submitHandling('Apple Pie')"> ADD TO CART </button>
                </form>
